...
Using distant viewing, I entered images with prompts to compare them if the Ai genereated text matches with the prompt or is it completely different. Furhtemrore, I used the 2.3 Image Classification to see what kind of categories does it predict the image to have and compare to the image and prompt.
