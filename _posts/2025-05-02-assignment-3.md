...
The comparison between DV Explorer's generated captions and original prompts reveals systematic oversimplification of complex visual narratives. Highly specific prompts like "cyberpunk cat bartender mixing neon cocktails" were reduced to generic descriptions such as "a cat sitting at a table," while surreal concepts like "kitten/spider hybrids in a 90s goth bedroom" became merely "cat on a bed." This pattern demonstrates the model's tendency to extract basic object relationships while discarding stylistic, narrative, and cultural context. Particularly striking was its failure to process textual humor cues, as seen when an "anti-drug PSA for catnip" meme was literally described as "cat on a book." These limitations reflect what Arnold & Tilton identify as AI's object-centric perception, where models recognize compositional elements but fail to reconstruct prompt-driven artistic intent or cultural semantics. The captions consistently privileged literal visual features over the conceptual richness embedded in prompts, underscoring the need for training approaches that better align visual patterns with creative context.
