...
This assignment explores how well AI can recognize and classify different qualities in cat images generated by other AIs on CIVITAI. I was curious to see if AI could understand and organize these visuals based on categories like Realistic, Artistic, Surreal, Humorous, and Abstract. The goal wasn’t just to test accuracy—it was also to reflect on what it means for machines to start interpreting images in ways we consider creative or conceptual.
