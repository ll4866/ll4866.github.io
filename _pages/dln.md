...
In terms of data analysis, I’ve used Voyant Tools for text analysis, while my Computer Science peers employ Python and R for data visualization. Film and New Media students also utilize Google Analytics to analyze audience engagement. Additionally, experimenting with Node-RED has expanded my understanding of data integration and decision-making. I’ve also started thinking more about how text analysis tools, particularly those that rely on OCR correction and structured data processing, impact the reliability of the data we work with. Errors in digitized texts or algorithmic biases in processing historical documents can influence the way we interpret findings, which makes it necessary to approach computational methods critically rather than assume they always produce objective results.
