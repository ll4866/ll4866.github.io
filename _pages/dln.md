...
Recently, I have been working on extracting data tables from the Zanzibar Gazette newspaper and converting them into structured CSV files. The process involves applying OCR (Optical Character Recognition) techniques to recognize and extract tabular data while ensuring accuracy in digitization. We are exploring different methods to automate this process efficiently, aiming to reduce the number of manual steps involved. This project has made me more aware of the challenges in working with historical printed materials, where inconsistent formatting and OCR errors can significantly impact the quality of structured data. It has also reinforced the importance of choosing the right tools and refining workflows to extract and transform data effectively.

### Exploring Digital Humanities
Digital humanities has shown me how technology can transform the study of history. Recently, our work focused specifically on historical newspapers as valuable public records containing extensive data on trade, transportation, climate, wave heights, and more. Unlike modern digital content, older newspapers often have complex layouts and inconsistent formatting, making data extraction challenging. However, digital tools allow us to systematically organize and analyze this wealth of information, revealing patterns that might otherwise remain hidden.

Through the NYUAD Library's Special Collections, I explored a broader range of historical media, including colonial-era maps, journals, letters, and photographs. While newspapers provide structured, data-rich content ideal for quantitative analysis, these other materials offer qualitative insights into historical narratives and perspectives. This experience reinforced the importance of digitizing diverse sources to make them more accessible and expanding the ways we analyze history through digital methods.

It also made me think about how computational methods differ from traditional close reading. Distant reading techniques allow us to analyze thousands of texts at once, but they also change how we engage with meaning, favoring patterns and data-driven insights over deep contextual understanding. This tension between scale and nuance is something I want to explore further, especially as I continue working with OCR correction and structured data analysis.
...
One of the readings this semester examined the role of microtasking in volunteer-based mapping, particularly in Humanitarian OpenStreetMap. The study explored how breaking large-scale tasks into smaller ones increases productivity but also concentrates contributions among a few highly active participants. This made me think about when I was working with my partner on our first assignment analyzing Shakespeare’s works. We split the tasks—one person worked with Voyant Tools while the other used Posit Cloud. Even though the division seemed fair at first, it became clear that some parts of the task required more time and effort than others.
...
While I’ve become proficient in tools like Unity, Figma, and GitHub, I’m eager to explore natural language processing and data storytelling further. AI’s role in interactive media, particularly in generative text models and immersive storytelling, fascinates me. I look forward to seeing how these tools can be applied both creatively and critically. At the same time, I’m keen to explore the ethical dimensions of digital work.

I also want to consider digital literacy beyond technical skill acquisition. Computational thinking has helped me approach problems systematically, but I’ve been thinking more about how it compares to phronesis—practical wisdom that comes from experience rather than algorithms. As I continue learning, I want to explore not just how digital tools function but how they shape the way we interpret, structure, and preserve knowledge.
